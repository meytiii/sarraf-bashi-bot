...
async def command_help_handler(message: types.Message) -> None:
    help_text = (
        ...
        "اصلاً نیازی نیست حتماً از دستور (اسلش) استفاده کنی! تو گروه یا همینجا پی‌ وی، کافیه اسم ارز یا چیزی که میخوای رو بگی تا من با یه بنر گرافیکی و نمودار جذاب جوابت رو بدم. مثلا:\n\n"
        "💵 بگو دلار -> تا قیمت لحظه‌ای دلار رو بگم\n"
        "🥇 بگو طلا -> تا قیمت یه گرم طلای ۱۸ عیار رو دربیارم\n"
        "💵 و هر چیز دیگه ای که پشتیبانی کنم.\n\n"
